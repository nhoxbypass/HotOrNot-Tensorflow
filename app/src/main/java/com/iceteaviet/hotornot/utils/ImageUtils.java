package com.iceteaviet.hotornot.utils;
...
import com.iceteaviet.hotornot.Logger;
...
public class ImageUtils {
    ...
    public static Bitmap getCroppedBitmap(Bitmap photoBitmap) {
        ...
        Matrix transformMatrix = getPhotoBitmapTransformationMatrix(photoBitmap);
        Canvas canvas = new Canvas(croppedBitmap);
        canvas.drawBitmap(photoBitmap, transformMatrix, null);
        return croppedBitmap;
    }

    private static Matrix getPhotoBitmapTransformationMatrix(Bitmap bitmap) {
